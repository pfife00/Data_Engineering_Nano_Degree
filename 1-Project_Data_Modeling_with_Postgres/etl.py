...
def process_log_file(cur, filepath):
    """
    Insert records into time, users, and songplays tables using the data from
    the log files.
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    Get all the files matching extension from directory, get the total number
    of files found, and iterate over the files and process the files.
    """
...
def main():
    """
    Main function to connect to sparkifydb and run process_data function.
    """
